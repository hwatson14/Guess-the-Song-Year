...
const checks=[
  ...
  ...['test_engine_v7','test_runtime_catalogue','test_runtime_recovery','test_spotify_session','test_engine_playback_lifecycle','test_year_gap_evidence',
    'test_year_range','test_catalogue_identity','test_song_database','test_mode_expansion','test_reviewed_mode_previews','test_provider_audit','test_preferred_link_cache','test_reviewed_provider_links','test_catalogue_corrections','test_catalogue_expansion','test_catalogue_cleanup','test_catalogue_bucket_uniqueness',
