...
const checks=[
  ...
  ...['test_engine_v7','test_runtime_catalogue','test_runtime_recovery','test_spotify_session','test_engine_playback_lifecycle','test_year_gap_evidence',
    ...
    'test_physical_ready','test_engine_playback_fixes','test_app_policy','test_card_year_overrides','test_security_contract'].map(name=>[process.execPath,`scripts/${name}.mjs`]),
