...
const checks=[
  ...
  ...['test_engine_v7','test_runtime_catalogue','test_runtime_recovery','test_spotify_session','test_spotify_background_playback','test_engine_playback_lifecycle','test_year_gap_evidence',
